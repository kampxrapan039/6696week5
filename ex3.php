...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($sum >= "80") {
      echo "<h1>ยินดีด้วยคุณสอบได้เกรด A </h1><br>";
    } elseif ($sum >= "70"){
      echo "<h1>ยินดีด้วยคุณได้เกรด B </h1><br>";
    } elseif ($sum >= "60"){
        echo "<h1>ยินดีด้วยคุณได้เกรด C </h1><br>";
    }elseif ($sum >= "50"){
        echo "<h1>ยินดีด้วยคุณได้เกรด D </h1><br>"; 
    }elseif ($sum <= "40"){
    echo "<h1>ยินดีด้วยคุณได้เกรด E </h1><br>";
}
